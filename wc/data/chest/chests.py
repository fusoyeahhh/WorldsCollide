...
from ..structures import DataArrays
from ..area_chests import area_chests
from ..item.item_names import id_name
from ..item import Item

from . import chests_asm
from . import Chest, DATA_SIZE
from .chest_item_tiers import weights
from .chest_item_tiers import tiers, tier_s_distribution
...
class Chests():
    ...
    def __init__(self, rom, args, items):
        ...
        self.chest_data = DataArrays(self.rom, self.PTRS_START, self.PTRS_END, self.rom.SHORT_PTR_SIZE, self.DATA_START, self.DATA_END, DATA_SIZE)

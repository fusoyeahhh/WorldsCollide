...
class Character():
    ...
    NAME_SIZE = 6
    DEFAULT_NAME = ["TERRA", "LOCKE", "CYAN", "SHADOW", "EDGAR", "SABIN", "CELES", "STRAGO", "RELM", "SETZER", "MOG",
                    "GAU", "GOGO", "UMARO"]
    ...
    def clear_init_equip(self):
        self.init_right_hand = Item.EMPTY
        self.init_left_hand = Item.EMPTY
        self.init_body = Item.EMPTY
        self.init_head = Item.EMPTY
        self.init_relic1 = Item.EMPTY
        self.init_relic2 = Item.EMPTY

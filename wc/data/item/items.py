...
from ...constants.items import good_items, name_id

from ..spell.spell_names import name_id as spell_name_id
from ..character.characters import Characters

from . import items_asm, text
from . import Item
from .item_custom_values import custom_values
...
class Items():
    ...
    def equipable_random(self, type_condition, rand_min, rand_max):
        for item in self.items:
            if item.is_equipable() and item.id != Item.EMPTY and type_condition(item.type):
